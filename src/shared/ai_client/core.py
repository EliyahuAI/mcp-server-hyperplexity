...
class AIAPIClient:
    ...
    async def call_structured_api(self, prompt: str, schema: Dict, model: Union[str, List[str]] = "claude-sonnet-4-5",
                                 ...
                                 use_code_extraction: bool = None, findall: bool = False) -> Dict:
        ...
        for model_index, current_model in enumerate(models_to_try):
            try:
                ...
                if api_provider == 'anthropic':
                    ...
                    result = await self.clone.make_structured_call(prompt, current_model, use_cache, cache_key, call_start_time, schema, soft_schema, debug_name, include_domains, exclude_domains, use_code_extraction, findall)
                else:
                    continue
