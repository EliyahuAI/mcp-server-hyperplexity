...
def create_email_body(session_id, total_rows, fields_validated, confidence_distribution, processing_time=None):
...
def send_validation_results_email(email_address, zip_content, session_id, summary_data, processing_time=None):
    """
