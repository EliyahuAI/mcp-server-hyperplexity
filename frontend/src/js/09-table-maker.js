...
function handleTableExecutionComplete(message) {
    ...
    if (tableMakerCardId) {
        ...
        if (card) {
            ...
            showMessage(`${tableMakerCardId}-messages`, `Table generation complete! ${message.row_count} rows ready for validation.`, 'success');
        }
    }
...
function handleTableExecutionUnrecoverable(message) {
    ...
    showMessage(`${tableMakerCardId}-messages`, message.user_facing_apology || "I wasn't able to find rows for this table.", 'error');
