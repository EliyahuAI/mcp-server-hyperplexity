            ...
            "next_steps": [
                {
                    ...
                    "note": (
                        ...
                        "Once the interview completes, a preview job is automatically queued "
                        "for API sessions — do NOT call create_job(). "
                        "Switch to wait_for_job(session_id) to track it with live progress "
