...
Additional paragraphs here will be ignored.
Only the first paragraph after the heading is used.
```

**Note**: Only the first paragraph after the heading is displayed to users. Any subsequent paragraphs (after a blank line) are ignored.
