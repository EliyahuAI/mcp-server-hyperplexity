...
2025-09-30: validation lambda logs tightened; bracket-prefixed/info-debug logs -> DEBUG; non-error ERRORs adjusted; fixed indentation in get_anthropic_api_key try block.
